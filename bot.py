...
from playwright_stealth import Stealth  # TAMA AT BAGONG IMPORT
...
async def deploy_to_cloud_run(magic_link: str, update: Update, status_msg) -> str:
    ...
    async with async_playwright() as p:
        ...
        # Fake User-Agent para magmukhang totoong tao
        ...
        # I-APPLY ANG STEALTH MODE (BAGONG PARAAN)
        stealth = Stealth()
        ...
        try:
            ...
            try:
                ...
                await update.message.reply_photo(photo=open("error_screen.png", 'rb'), 
                                               caption="❌ Na-block pa rin tayo ng Google kahit naka-Stealth! Tingnan ang screenshot.")
...
if __name__ == '__main__':
    ...
    if BOT_TOKEN:
        ...
        # ITO ANG FIX PARA SA CONFLICT ERROR:
